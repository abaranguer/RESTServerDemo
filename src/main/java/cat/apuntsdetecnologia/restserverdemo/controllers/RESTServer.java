...
import cat.apuntsdetecnologia.restserverdemo.model.XmlError;
...
public class RESTServer {
	...
	@RequestMapping("/demo")
	public Address demo(@RequestParam(value = "first", defaultValue = "John") String firstName,
	...
	public Address toUpper(@RequestBody Address address,
	...
	@RequestMapping("/toupperwitherror")
	public XmlError toUppeWithErrorr(@RequestBody Address address,
			@RequestParam(value = "first", defaultValue = "John") String firstName,
			@RequestParam(value = "second", defaultValue = "Smith") String secondName) {

		XmlError xmlError = new XmlError();
		xmlError.setErrorCode("error-code-dummy");
		xmlError.setDescription(String.format("error description : %s %s",
				address.getPerson().getFirstName().toUpperCase(), address.getPerson().getSecondName().toUpperCase()));
